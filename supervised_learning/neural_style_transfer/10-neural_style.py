#!/usr/bin/env python3
"""
Neural Style Transfer module with Variational Cost and Image Generation
"""
import numpy as np
...
class NST:
    ...
    def variational_cost(generated_image):
        ...
        h_cost = tf.reduce_sum(
            tf.abs(generated_image[:, :-1, :, :] - generated_image[:, 1:, :, :])
        )
    ...
    def generate_image(self, iterations=1000, step=None, lr=0.01,
        ...
        """
        Generates the stylized image using gradient descent.
        """
